var swiper = new Swiper(".mySwiper", {  
 ...
 breakpoints: {
  0: { slidesPerView: 1, spaceBetween: 0, slidesPerGroup: 1, centeredSlides: true},
  576: { slidesPerView: 1,spaceBetween: 0, slidesPerGroup: 1, centeredSlides: true},
  768: { slidesPerView: 2, slidesPerGroup: 2, centeredSlides: false},
  992: { slidesPerView: 2, slidesPerGroup: 2, centeredSlides:  false},
  1200:{ slidesPerView: 2, slidesPerGroup: 2, centeredSlides: false }
 }
});
...
const screensSwiper = new Swiper('.screens-swiper', {
 ...
 breakpoints: {
  0: { slidesPerView: 'auto', spaceBetween: 10, centeredSlides: true, loop: false },
  576: { slidesPerView: 'auto', spaceBetween: 15, centeredSlides: true, loop: false },
  768: { slidesPerView: 'auto', spaceBetween: 15, centeredSlides: true, loop: false },
